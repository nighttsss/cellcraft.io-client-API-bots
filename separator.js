...
global.url = "ws://cellcraft.io:4041/";
global.headers = {
...
setInterval(() => {
    ...
    console.log(`HTTP/HTTPS: ${workingHTTPProxies} SOCKS5/4: ${workingSocksProxies} TOTAL WORKING PROXIES: ${workingHTTPProxies + workingSocksProxies} Checked: ${checkerInstances.length} / ${proxies.length}`);
}, 550);
